...
func (o *appOptions) parse() error {
	...
	flag.StringVar(&o.optionLogScannedFiles, "success-log", "", "logs scanned files to a file, needed when you want to resume a paused scan")
	flag.StringVar(&o.optionLogFilesWhichCouldNotBeScanned, "failed-log", "", "logs files, which could not be scanned, to a file")
